...
export default {
                ...
                options: {
                    ...
                    series: [{
                            ...
                            itemStyle: {
                                barBorderRadius: 20,
                                // color: "red"
                                color: params => ['#1089E7', '#F57474', '#56D0E3', '#F8B448', '#8B78F6'][params.dataIndex % ['#1089E7', '#F57474', '#56D0E3', '#F8B448', '#8B78F6'].length]
                            },
                            // 柱子内的文字
                            label: {
                                show: true,
    ...
    mounted() {
        ...
        AList[0].addEventListener('click', () => {
            ...
            this.chartB.options.series[0].data = this.yearData[0].data[0];
            this.chartB.options.series[1].data = this.yearData[0].data[1];
            const temp = this.chartB.options;
            // this.chartB.options = JSON.parse(JSON.stringify(temp));
        });
        AList[1].addEventListener('click', () => {
            AList[1].classList.remove('active');
            AList[1].classList.add('active');
            AList[0].classList.remove('active');
            this.chartB.options.series[0].data = this.yearData[1].data[0];
            this.chartB.options.series[1].data = this.yearData[1].data[1];
            const temp = this.chartB.options;
            // this.chartB.options = JSON.parse(JSON.stringify(temp));
        });
    }
